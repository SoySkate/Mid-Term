...
async function dataJson() {
  try {
    ...
    let dataRecieve = "";
    dataRecieve += `
    <h1 class="text-7xl my-20 mx-40 font-bold text-[#292e47] ">${getData[3].title.slice(
      0,
      8
    )}</h1>
      <div class="mx-40 pb-36 mb-8">
<div class="flex justify-center">
      <img class=" mb-16 w-screen h-96" src="${getData[3].id}.jpeg"></img></div>
      <div class="">
      <p class="mb-8 text-2xl text-[#292e47]">${getData[3].body}</p></div></div>
          `;
